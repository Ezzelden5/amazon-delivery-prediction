...
MODEL_PATH = APP_DIR / "final_model_delivery_pipeline(grid2).pkl"
DATA_PATH = APP_DIR / "cleaned_amazon_delivery.csv"
...
if page == "1. Business Case & Data":
  ...
  **Every day, millions of orders are delivered worldwide.**
      ...
      **By building a model that predicts delivery time during day time with high accuracy.
     **Business impact:**
